-- Essential RLS Policies for Iyaya App (Revised)
...
DROP POLICY IF EXISTS "Users can view own caregiver profile" ON public.caregiver_profiles;
...
DROP POLICY IF EXISTS "Authenticated users can view caregiver profiles" ON public.caregiver_profiles;
